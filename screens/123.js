        ...
        <View>
          <View style={styles.sectionContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  conn
                    ...
                    .catch(function (err) {
                      console.log(
                        `Error sending ${message} from ${user}: ${err.message}`,
                      );
                    });
                  onChangeMessageText('');
                }}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  conn
                    ...
                    .then(() => {
                      console.log(
                        `Connected to the hub endpoint: ${hub_endpoint}`,
                      );
                      setConnectedStateText('Connected to ' + hub_endpoint);
                      setConnected(true);
                    })
                    .catch((err) =>
                      console.log(
                        `Error starting the connection: ${err.toString()}`,
                      ),
                    );
                }}>
            ...
            <FlatList
              ...
              renderItem={({item}) => (
                <MessageItem
                  title={'\u2B24 ' + item.user + ' says: ' + item.message}
                />
              )}
